(function(){
  ...
  function wizardStep3(){
    ...
    <form data-form="w3">
      ...
      <div class="field"><label for="w-o-theory">Their theory</label><textarea class="textarea input" id="w-o-theory" name="w-o-theory" placeholder="Why do they make the list?"></textarea></div>
      <div class="field">
