(function(){
  ...
  function wizardStep6(){
    ...
    return h`<div class="wizard-eyebrow">Step 6 of ${wizardStepCount()} &middot; Final answer</div>
    <div class="wizard-q">You're at 50% — lock in your final suspect</div>
    <p style="color:var(--text-dim);font-size:16.5px;margin-bottom:18px;font-family:var(--font-type)">Once locked, no more suspects or theories can be added or changed. Choose carefully.</p>
  ...
  function caseHTML(){
    ...
    out += twistsSectionHTML(c, !locked && !closed);
