      ...
      <div style="display:flex;flex-direction:column;gap:8px;width:150px;flex:none">
        ...
        ${coverEditOpen ? h`
          <form data-form="custom-cover" style="display:flex;flex-direction:column;gap:6px">
            <input class="input" name="url" type="url" placeholder="Paste an image URL" style="font-size:13px;padding:8px 10px" value="${escapeHtml((c.coverUrl && c.coverUrl.indexOf('data:')!==0) ? c.coverUrl : '')}">
            <div style="display:flex;gap:6px">
              <button class="btn btn-gold" type="submit" style="flex:1;padding:6px 8px;font-size:13px">Save link</button>
            ...
            <div style="text-align:center;font-size:12px;color:var(--text-faint);margin:2px 0">— or —</div>
